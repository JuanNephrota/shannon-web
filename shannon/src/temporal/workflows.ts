...
// Non-retryable error types (shared between configs)
...
const PRODUCTION_RETRY: NonNullable<ActivityOptions['retry']> = {
...
const TESTING_RETRY: NonNullable<ActivityOptions['retry']> = {
